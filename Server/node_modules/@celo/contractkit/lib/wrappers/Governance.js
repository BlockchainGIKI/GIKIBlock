...
var GovernanceWrapper = /** @class */ (function (_super) {
    ...
    GovernanceWrapper.prototype.getConstitution = function (proposal) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        constitution = (0, fixidity_1.fromFixed)(new bignumber_js_1.default('500000000000000000000000'));
    ...
    GovernanceWrapper.prototype.getSupport = function (proposalID) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, participation, votes, lockedGold, quorum, total, networkWeight, required, support;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), participation = _a[0], votes = _a[1], lockedGold = _a[2];
    ...
    GovernanceWrapper.prototype.getApprovalStatus = function (proposalID) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, multisig, approveTx, _b, multisigTxs, approvers, confirmations;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, Promise.all([
                    ...
                    case 1:
                        _a = _c.sent(), multisig = _a[0], approveTx = _a[1];
                        return [4 /*yield*/, Promise.all([
                                multisig.getTransactionDataByContent(this.address, approveTx.txo),
                                multisig.getOwners(),
                            ])];
                    case 2:
                        _b = _c.sent(), multisigTxs = _b[0], approvers = _b[1];
    ...
    GovernanceWrapper.prototype.getProposalRecord = function (proposalID) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, proposal, metadata, stage, record, _b, _c, passed, votes, approved, approvals;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        _a = _d.sent(), proposal = _a[0], metadata = _a[1], stage = _a[2];
                        record = {
                            proposal: proposal,
                            metadata: metadata,
                            stage: stage,
                        ...
                        if (!(stage === ProposalStage.Queued)) return [3 /*break*/, 3];
                        _b = record;
                    ...
                    case 2:
                        ...
                        return [3 /*break*/, 5];
                    case 3:
                        if (!(stage === ProposalStage.Referendum || stage === ProposalStage.Execution)) return [3 /*break*/, 5];
                        return [4 /*yield*/, Promise.all([
                    ...
                    case 4:
                        _c = _d.sent(), passed = _c[0], votes = _c[1], approved = _c[2], approvals = _c[3];
                        record.passed = passed;
                        record.votes = votes;
                        record.approved = approved;
                        record.approvals = approvals;
                        _d.label = 5;
                    case 5: return [2 /*return*/, record];
                }
            });
        });
    };
